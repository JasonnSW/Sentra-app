...
const VerificationSuccessEmailModal = ({ visible, onClose }: Props) => {
  return (
    <Modal visible={visible} animationType="slide" transparent={false}>
      <SafeAreaView className="flex-1 items-center justify-center bg-white w-full h-full">
        <View className="items-center justify-center px-8 w-full">
          <MaterialIcons name="email" size={200} color="#00027d" />
          <Text className="font-bold text-center text-4xl w-fit mb-2">
            Email anda berhasil dimodifikasi
          </Text>
          <TouchableOpacity
            onPress={onClose}
...
export default VerificationSuccessEmailModal;