import VerificationSuccessEmailModal from "@/features/profiles/components/verification-email-success-modal";
        ...
        <ScrollView className="p-6 flex-grow">
          <View className="flex flex-col items-start justify-start w-full">
            ...
            <Text className="text-sm mt-1">
              Kami telah mengirimkan email dengan kode aktivasi kepada email
              anda {email}
            </Text>
          </View>
